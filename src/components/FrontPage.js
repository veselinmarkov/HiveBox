...
export default function FrontPage() {
    ...
    const introLines = [
        { "text": "Continuous beehive climate supervision and control trough Internet" },
        { "text": "Keeping optimal temperature and humidity for the bee colony during the winter period" },
        { "text": "Protection of the bee colony and its brood during the cold spring turnovers" },
        { "text": "Beehive sound transmission to the beekeeper and its recording" },
        { "text": "Possibility to initiate cleansing flights during windless or warm winter days" },
        { "text": "Enhance beehive ventilation during the hot summer days" },
    ]
